...
resource "aws_instance" "MySQL_master" {
  ...
  vpc_security_group_ids = [aws_security_group.MySQL.id , module.module_vpc_reut.aws__default_security_group.default.ids[0] , aws_security_group.consul-cluster-vpc.id]
